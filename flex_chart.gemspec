...
Gem::Specification.new do |s|
  ...
  s.email = %q{ron@ronmcclain.com}
  s.extra_rdoc_files = ["README.rdoc", "lib/flex_chart.rb"]
  s.files = ["README.rdoc", "flex/FlexGraph.swf", "flex/FlexGraph.mxml", "lib/flex_chart.rb", "Rakefile", "Manifest", "flex_chart.gemspec"]
  s.has_rdoc = true
